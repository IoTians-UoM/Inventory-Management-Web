...
// import { InventoryItem, Message, Product as ProductType, Type } from './types/types';
...
//   useEffect(() => {
//     initWS('ws://192.168.112.97:8000', setMessages);
//   }, []);
...
//     switch (message.type) {
//       case Type.PRODUCT:
//         setProducts(message.data as ProductType[]);
//         break;
//       case Type.INVENTORY:
//         setInventory(message.data as InventoryItem[]);
//         break;
//       default:
//         break;
//     }
